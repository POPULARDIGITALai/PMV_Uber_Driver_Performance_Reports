...
#             # Correlation plot option removed
...
#             if analysis_type == 'Correlation Scatter Plot':
#                 st.markdown("""
#                 **Correlation Analysis Features:**
#                 - **6 correlation plots** showing relationships between key metrics
#                 - **Hover** over points for detailed driver information
#                 - **Correlation coefficients (r)** and sample sizes (n) in subplot titles
#                 - **Color coding** by DP Working Plan when viewing all schemes
#                 - **Zoom** and **pan** on individual subplots for detailed analysis
#                 - Each point represents **one unique driver**
#                 """)
#             else:
#                 st.markdown(f"""
#                 **{analysis_type} Features:**
#                 - **Hover** over points for detailed driver information including ID, earnings, tenure, hours
